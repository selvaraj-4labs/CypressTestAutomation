...
Then('It should display notification as {string}', function(notifyMsg) {
    cy.get('.notifications-container .color-secondary-dark').eq(0)
        .should('contain.text',notifyMsg)
    cy.xpath(`//*[contains(text(),"${notifyMsg}")]`)
        .should('exist')
})
